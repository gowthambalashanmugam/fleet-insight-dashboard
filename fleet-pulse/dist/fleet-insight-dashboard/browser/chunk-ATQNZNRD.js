...
var LoginComponent = class _LoginComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["app-login"]], decls: 22, vars: 3, consts: [[1, "flex", "h-screen"], [1, "flex", "w-1/2", "items-center", "justify-center", "bg-gray-900", "px-12"], [1, "w-full", "max-w-md"], [1, "mb-10"], [1, "text-3xl", "font-bold", "text-white"], [1, "mt-2", "text-sm", "text-gray-400"], [1, "space-y-6", 3, "ngSubmit"], ["for", "username", 1, "block", "text-sm", "font-medium", "text-gray-300"], ["id", "username", "type", "text", "name", "username", "required", "", "autocomplete", "username", "placeholder", "Enter your username", 1, "mt-1", "block", "w-full", "rounded-lg", "border", "border-gray-700", "bg-gray-800", "px-4", "py-3", "text-white", "placeholder-gray-500", "focus:border-indigo-500", "focus:ring-2", "focus:ring-indigo-500", "focus:outline-none", 3, "ngModelChange", "ngModel"], ["for", "password", 1, "block", "text-sm", "font-medium", "text-gray-300"], ["id", "password", "type", "password", "name", "password", "required", "", "autocomplete", "current-password", "placeholder", "Enter your password", 1, "mt-1", "block", "w-full", "rounded-lg", "border", "border-gray-700", "bg-gray-800", "px-4", "py-3", "text-white", "placeholder-gray-500", "focus:border-indigo-500", "focus:ring-2", "focus:ring-indigo-500", "focus:outline-none", 3, "ngModelChange", "ngModel"], [1, "text-sm", "text-red-400"], ["type", "submit", 1, "w-full", "rounded-lg", "bg-indigo-600", "px-4", "py-3", "text-sm", "font-semibold", "text-white", "hover:bg-indigo-500", "focus:ring-2", "focus:ring-indigo-500", "focus:ring-offset-2", "focus:ring-offset-gray-900", "focus:outline-none", "transition-colors"], [1, "hidden", "w-1/2", "lg:block"], ["src", "images/login-bg.png", "alt", "Fleet truck on a city road at night", 1, "h-full", "w-full", "object-cover"]], template: function LoginComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div", 2)(3, "div", 3)(4, "h1", 4);
      \u0275\u0275text(5, "FleetInsight");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(6, "p", 5);
      \u0275\u0275text(7, "Sign in to your dashboard");
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(17, LoginComponent_Conditional_17_Template, 2, 1, "p", 11);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(LoginComponent, [{
    type: Component,
    args: [{ selector: "app-login", imports: [FormsModule], template: '<div class="flex h-screen">\n  <!-- Left side: Login form -->\n  <div class="flex w-1/2 items-center justify-center bg-gray-900 px-12">\n    <div class="w-full max-w-md">\n      <div class="mb-10">\n        <h1 class="text-3xl font-bold text-white">FleetInsight</h1>\n        <p class="mt-2 text-sm text-gray-400">Sign in to your dashboard</p>\n      </div>\n\n      <form (ngSubmit)="onSubmit()" class="space-y-6">\n        <div>\n          <label for="username" class="block text-sm font-medium text-gray-300">\n            Username\n          </label>\n          <input\n            id="username"\n            type="text"\n            [(ngModel)]="username"\n            name="username"\n            required\n            autocomplete="username"\n            placeholder="Enter your username"\n            class="mt-1 block w-full rounded-lg border border-gray-700 bg-gray-800 px-4 py-3 text-white placeholder-gray-500 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 focus:outline-none"\n          />\n        </div>\n\n        <div>\n          <label for="password" class="block text-sm font-medium text-gray-300">\n            Password\n          </label>\n          <input\n            id="password"\n            type="password"\n            [(ngModel)]="password"\n            name="password"\n            required\n            autocomplete="current-password"\n            placeholder="Enter your password"\n            class="mt-1 block w-full rounded-lg border border-gray-700 bg-gray-800 px-4 py-3 text-white placeholder-gray-500 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 focus:outline-none"\n          />\n        </div>\n\n        @if (error()) {\n          <p class="text-sm text-red-400">{{ error() }}</p>\n        }\n\n        <button\n          type="submit"\n          class="w-full rounded-lg bg-indigo-600 px-4 py-3 text-sm font-semibold text-white hover:bg-indigo-500 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-900 focus:outline-none transition-colors"\n        >\n          Sign In\n        </button>\n      </form>\n    </div>\n  </div>\n\n  <!-- Right side: Image -->\n  <div class="hidden w-1/2 lg:block">\n    <img\n      src="images/login-bg.png"\n      alt="Fleet truck on a city road at night"\n      class="h-full w-full object-cover"\n    />\n  </div>\n</div>\n', styles: ["/* src/app/features/login/login.component.scss */\n/*# sourceMappingURL=login.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LoginComponent, { className: "LoginComponent", filePath: "src/app/features/login/login.component.ts", lineNumber: 11 });
})();
export {
  LoginComponent
};
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-ATQNZNRD.js.map
